...
application.get('/image/:image', (req,res) => {res.sendFile(__dirname + '/pictures/' + req.params['image'])});
application.get('/css/:file', (req,res) => {res.sendFile(process.env.baseName + '/styleSheets/css/' + req.params['file'])});
application.get('/js/:file', (req,res) => {res.sendFile(process.env.baseName + '/javaScript/' + req.params['file'])});
